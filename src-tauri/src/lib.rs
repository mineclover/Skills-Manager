...
use commands::{
    ...
    rename_path, rescan_skill, save_config, save_llm_provider, scan_all_risks,
    scan_existing_skills, scan_skills_for_scope, set_active_project_binding, set_preset_all,
    set_preset_skill, set_skill_set_assignment_active, set_tool_enabled, start_github_auth,
