...
use commands::{
    ...
    preview_batch_skill_tools, preview_clawhub_publish, preview_import_skills,
    preview_preset_for_target, preview_project_binding, preview_skill_operation,
    ...
    save_config, save_llm_provider, save_local_skill_contract, scan_all_risks,
    scan_existing_skills, scan_skills_for_scope, set_active_project_binding, set_preset_all,
    set_preset_skill, set_skill_set_assignment_active, set_skill_set_assignment_priority,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            enable_skill,
            disable_skill,
            preview_batch_skill_tools,
            batch_set_skill_tools,
            apply_preset,
            apply_preset_for_scope,
            preview_preset_for_target,
